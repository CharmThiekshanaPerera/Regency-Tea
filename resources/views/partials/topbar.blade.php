...
<div class="border-b border-stone-800 bg-stone-950 text-stone-300">
    <div class="mx-auto flex max-w-7xl items-center justify-end gap-4 px-4 py-2 text-xs">
        ...
        <a href="{{ route('catalogue') }}"
           class="flex items-center gap-1.5 font-medium text-stone-300 transition hover:text-white">
            ...
            <span class="hidden sm:inline">Download Catalogue</span>
        </a>
